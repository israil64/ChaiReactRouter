...
export default function Contact() {
  return (
    <>
      <div className="py-8 lg:py-16 px-4  bg-white dark:bg-gray-800 dark:text-white">
        <div class="mx-auto max-w-7xl px-4">
          <div class="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
            <div class="mx-auto max-w-max rounded-full border bg-gray-50 p-1 px-3">
              <p class="text-center text-xs font-semibold leading-normal md:text-sm dark:bg-black dark:text-white">
                Share your thoughts
              </p>
            </div>
                ...
                <div class="px-2 md:px-12">
                  ...
                  <form action="" class="mt-8 space-y-4">
                    <div class="grid w-full gap-y-4 md:gap-x-4 lg:grid-cols-2">
                      ...
                      <div class="grid w-full  items-center gap-1.5 ml-3">
                        <label
                          class="text-sm font-medium leading-none text-gray-700 peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                          for="last_name"
                        >
                    ...
                    <button
                      type="button"
                      class="w-full rounded-md bg-purple-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black dark:text-white"
                    >
                      Send Message
                    </button>
                  </form>
